    ...
    with app.app_context():
        try:
            ...
            for product in products:
                ...
                if product_data:
                    logger.info(f"Triggering forecast for product {product.model_code}")
                    ...
                    logger.warning(f"No sales data found for product {product.model_code} to generate forecast.")
