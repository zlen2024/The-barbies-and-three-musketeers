      ...
      <div className="h-full overflow-y-auto lg:overflow-hidden grid grid-cols-1 lg:grid-cols-4 gap-6">
        ...
        <div className="col-span-1 lg:col-span-3 space-y-6 lg:h-full lg:overflow-y-auto lg:pr-2">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                {/* Sales Trend */}
                <Card className="col-span-1 md:col-span-2 cursor-pointer hover:shadow-lg transition-shadow" onClick={() => navigate(`/forecast?sku=${product.sku}`)}>
                    <div className="flex justify-between items-center">
                        ...
                        <Button
                            ...
                            onClick={(e) => {
                                e.stopPropagation();
                                navigate(`/forecast?sku=${product.sku}`);
                            }}
                        >
                            Go to Forecast
                        </Button>
