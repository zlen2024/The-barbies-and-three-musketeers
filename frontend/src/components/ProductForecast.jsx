...
import { Card, Title, Text, Button, Select, SelectItem, TextInput, Textarea } from "@tremor/react";
...
const ProductForecast = () => {
  ...
  const handleProject = () => {
      // In a real app, this would send the prompt, sampleSize, and projectionSize to a backend AI service
      // For now, let's just show an alert or a simple UI response
    ...
    <Layout isFixed={true} isDark={true}>
      <div className="flex h-[calc(100vh-64px)] overflow-hidden">
        ...
        <div className="flex-1 bg-gray-950 flex flex-col overflow-hidden relative">
            ...
            <div className="bg-gray-900 border-t border-gray-800 p-6 flex-none">
